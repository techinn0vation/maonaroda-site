...
import DisplayTypography from '@/components/Typography'
...
import {
  ...
  HeadlineQuemSomos,
  WrapperText
} from '@/components/QuemSomos/styles'
  ...
  return (
    <Layout>
      <WrapperQuemSomos>
        <ContentQuemSomos>
          <HeadlineQuemSomos>
            <DisplayTitle DisplayTitle="visão" />
          </HeadlineQuemSomos>
          <WrapperText>
            <DisplayTypography
              DisplayTypography="Nosso objetivo é revolucionar a forma como os serviços domésticos são prestados,
           oferecendo conveniência, confiabilidade e qualidade em cada interação."
            />
          </WrapperText>
          {/*  */}
          <HeadlineQuemSomos>
            <DisplayTitle DisplayTitle="nossa missão" />
          </HeadlineQuemSomos>
          <WrapperText>
            <DisplayTypography
              DisplayTypography="nosso propósito é simplificar a vida das pessoas, conectando clientes que buscam serviços especializados a profissionais qualificados,
          ...
          <WrapperText>
            ...
            <DisplayTypography
              DisplayTypography="
              Inovação: Estamos constantemente em busca de soluções inovadoras para melhorar a experiência dos clientes e profissionais,
            ...
            <DisplayTypography
              DisplayTypography="
              Além disso, garantimos que os serviços sejam exibidos apenas para os profissionais dentro de um raio de 30 km do cliente,
